...
npireps_0_01_total_cost_unc05 = get_data('/home/vgomez/rllab/data/local/experiment/experiment_2017_02_23_22_17_38_0001/progress.csv','Total cost');
npireps_0_01_avg_return_unc05 = get_data('/home/vgomez/rllab/data/local/experiment/experiment_2017_02_23_22_17_38_0001/progress.csv','AverageReturn');
...
plot(npireps_0_1_total_cost_unc05_lambda2);
plot(npireps_0_2_total_cost_unc05_lambda2);
plot(npireps_0_3_total_cost_unc05_lambda2);
grid on;
ylabel('Total Cost');
title('N = 400')
...
plot(npireps_0_1_avg_return_unc05_lambda2);
plot(npireps_0_2_avg_return_unc05_lambda2);
plot(npireps_0_3_avg_return_unc05_lambda2);
...
hold on;
plot(npireps_0_01_total_cost_unc05);
...
ylabel('Average Reward');
hold on;
plot(npireps_0_01_avg_return_unc05);
